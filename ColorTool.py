...
def color_large_raster(input_path, output_path, remap_dict, color_table_dict):
    ...
    out_ds = driver.Create(
        ...
        options=["TILED=YES", "COMPRESS=DEFLATE", "BIGTIFF=IF_SAFER", "PREDICTOR=2", "NUM_THREADS=ALL_CPUS","NUM_THREADS=ALL_CPUS","OPTIMIZE_SIZE=YES","SPARSE_OK=YES"]
    )
