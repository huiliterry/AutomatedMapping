# -*- coding: utf-8 -*-
"""CombinationS2L89.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1z5pqqWNqth5Fwhj7A0vP1uEflVbfHlPM
"""
...
import sys
sys.path.append('/content/drive/MyDrive/Colab Notebooks/InseasonAutomated')

from l89mappingtools import L89MosaicClassification
from s2mappingtools import S2MosaicClassification

"""Processing - Mosaic L89 and S2 (S2 cover L89)"""

def mosaic_L89_S2_gdal(output_path,month):
  l89_path = os.path.join(output_path, f"{month}_L89mosaic_output.tif")
  s2_path = os.path.join(output_path, f"{month}_S2mosaic_output.tif")
...
# CONUSBoundary = ee.FeatureCollection("TIGER/2018/States").filter(ee.Filter.eq('NAME', 'Nebraska')).geometry()
...
mosaicFolder = 'AutoInseasonL89S2_Mosaic'
folderPath = root_path + mosaicFolder # '/content/drive/MyDrive/' could be set to any root direction


def mosaic_remap_collor_conver(startDate,endDate,month,L89cloudCover,S2cloudCover,CONUSBoundary,CONUStrainingLabel, L89tileFolder,S2tileFolder,mosaicFolder):
  def run_landsat():
      # image title: month+"_L89mosaic_output.tif"
      L89MosaicClassification(startDate, endDate, month, L89cloudCover, CONUSBoundary, CONUStrainingLabel, L89tileFolder, mosaicFolder)

  def run_sentinel():
      # image title: month+"_S2mosaic_output.tif"
      S2MosaicClassification(startDate, endDate, month, S2cloudCover, CONUSBoundary, CONUStrainingLabel, S2tileFolder, mosaicFolder)
  ...
  if __name__ == '__main__':
      ...
      try:
          ...
          mosaic_L89_S2_gdal(folderPath, month)
      ...
      mosaicedFilePath = folderPath+f'/{month}_L89_S2_merged.tif'
      outcolor_tif = folderPath+f'/{month}_L89_S2_remapcolor.tif'
      output_erdas_path = folderPath+f'/{month}_L89_S2_erdas.img'
...
mosaic_remap_collor_conver(startDate,endDate,month,L89cloudCover,S2cloudCover,CONUSBoundary,CONUStrainingLabel, L89tileFolder,S2tileFolder,mosaicFolder)