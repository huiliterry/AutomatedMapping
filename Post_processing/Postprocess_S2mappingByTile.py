...
def S2MosaicClassification(startDate, month, cloudCover, S2_tilelist, CONUStrainingLabel, tileFolder, local_root_folder, mosaicFolder,file_name):
...
S2tilelist = ['10SFE','10SFG','10SFH','10SFJ','10SGE','10SGF','10SGG','11SKA','11SKV','11SLA']
S2MosaicClassification(startDate, month, S2cloudCover, S2tilelist, CONUStrainingLabel, S2tileFolder, local_root_folder, mosaicfolder_path, s2_name)
